...
full_n_train = [500; 1000; 1500; 2000; 2500; 3000; 3500; 4000; 4500; 5000];
% full_n_train = [500; 1000];

%% Params for Sparse GP
sparse_MAX_NUM_EVAL = 200;
sparse_n_train = [1000; 2000; 3000; 4000; 5000; 6000; 7000; 8000; 9000; 10000];
...
save('all_results.mat', 'fgp_history', 'sgp_history', 'dgp_history')
