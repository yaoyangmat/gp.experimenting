...
% full_n_train = [1000; 1500; 2000; 2500; 3000; 3500; 4000; 4500; 5000; 5500];
full_n_train = [1000];

%% Params for Sparse GP
sparse_MAX_NUM_EVAL = 200;
sparse_n_train = [4000; 5000; 6000; 7000; 8000; 9000; 10000; 11000; 12000; 13000];
% sparse_n_train = [1000; 2000];
n_sparse = sparse_n_train/10;

%% Params for Distributed GP
dist_MAX_NUM_EVAL = 200;
dist_n_train = [10000; 20000; 30000; 40000; 50000; 60000; 70000; 80000; 90000; 100000];
...
save('dgp_results_15.mat', 'fgp_history', 'sgp_history', 'dgp_history')
